    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paymentcard_card_number', models.ForeignKey(db_column='PaymentCard_card_number', on_delete=django.db.models.deletion.DO_NOTHING, to='store.paymentcard')),
                ('promotion_promo', models.ForeignKey(db_column='Promotion_promo_id', on_delete=django.db.models.deletion.DO_NOTHING, to='store.promotion')),
                ('users_userid', models.ForeignKey(db_column='Users_userID', on_delete=django.db.models.deletion.DO_NOTHING, to='store.users')),
            ],
            options={
                'db_table': 'Order',
